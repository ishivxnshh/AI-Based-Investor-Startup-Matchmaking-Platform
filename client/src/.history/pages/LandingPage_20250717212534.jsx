          ...
          <div className="max-w-5xl w-full text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 justify-items-center">
              <div className="bg-white/10 p-6 rounded-lg border border-gray-500 w-full max-w-xs">
                ...
                <p className="text-gray-300 text-sm mt-2">Great Leader with Visionary ntrepreneur, Passionate about AI and Startups and 😎Here working as Backend Developer.</p>
