        ...
        <section id="contact-team" className="px-4 py-20 flex justify-center bg-black/60">
          <div className="max-w-5xl w-full text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 justify-items-center">
              ...
              <div className="bg-white/10 p-6 rounded-lg border border-gray-500 w-full max-w-xs">
                <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="Shivansh Mittal
" className="w-25 h-28 rounded-full mx-auto mb-4 border-2 border-purple-500" />
                <h3 className="text-xl font-semibold">Shivansh Mittal
</h3>
