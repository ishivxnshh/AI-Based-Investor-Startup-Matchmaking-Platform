          ...
          <div className="max-w-5xl w-full text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 justify-items-center">
              <div className="bg-white/10 p-6 rounded-lg border border-gray-500 w-full max-w-xs">
                <img src="https://i.ibb.co/PzgvcL73/IMG-20250717-WA0017.jpg" alt="Aditya Verma" className="w-18 h-23 rounded-full mx-auto mb-4 border-2 border-purple-500" />
              ...
              <div className="bg-white/10 p-6 rounded-lg border border-gray-500 w-full max-w-xs">
                <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="Rohit Sharma" className="w-18 h-23 rounded-full mx-auto mb-4 border-2 border-purple-500" />
              ...
              <div className="bg-white/10 p-6 rounded-lg border border-gray-500 w-full max-w-xs">
                <img src="https://randomuser.me/api/portraits/women/68.jpg" alt="Priya Singh" className="w-18 h-23 rounded-full mx-auto mb-4 border-2 border-purple-500" />
