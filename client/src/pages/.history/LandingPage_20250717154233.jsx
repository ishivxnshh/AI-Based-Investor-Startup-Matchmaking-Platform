        ...
        <section className="flex flex-col items-center justify-center py-12 px-4 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center">
            <img
              ...
              className="rounded-lg shadow-lg w-full max-w-xl border-4 border-purple-500"
              style={{objectFit: 'cover', height: '320px'}}
            />
            <span className="text-xs text-gray-400 mt-2">*AI-generated image representing a successful investor-startup meeting</span>
          </div>
        </section>
