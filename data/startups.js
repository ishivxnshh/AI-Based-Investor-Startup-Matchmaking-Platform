...
const sampleUpdates = [
    {
        ...
        content: "Successfully launched our beta version with 500+ active users providing valuable feedback for improvements."
    },
    {
        date: "February 28, 2024",
        title: "Partnership Announcement",
        content: "Signed strategic partnership with leading industry players to expand our market reach and accelerate growth."
    },
    {
        date: "February 10, 2024",
        title: "Team Expansion",
        content: "Welcomed 5 new team members including senior developers and marketing specialists to support our growth phase."
    },
    {
        date: "January 22, 2024",
        title: "Funding Round Progress",
        content: "Successfully reached 75% of our funding goal with strong investor interest and positive market response."
    }
];

// Utility functions
function getStartupById(id) {
    return startupsData.find(startup => startup.id === parseInt(id));
}

function getStartupsByIndustry(industry) {
    if (industry === 'all') return startupsData;
    return startupsData.filter(startup => startup.industry === industry);
}
